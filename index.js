...
// const userContainerTabs = document.querySelector(".weather-container");
// const grantAccessContainer = document.querySelector(".grant-location-container");
// const searchForm = document.querySelectorAll("[data-searchForm]");
// const loadingScreen = document.querySelector(".loading-containe");
// const userInfoContainer = document.querySelector(".user-info-container");


// let currentTab  = userTabs;
// const API_KEY = "a083d2acb8a3abb461eaa1c8da4e9e3d";
...
//         countryIcon.innerText = `https://flagcdn.com/144x108/${weatherInfo?.sys?.country.toLowerCase()}.png`;
